                ...
                <div class="card-body">
                    <form class="form-horizontal form-material mx-2" action="{{ route('admin.books.store') }}" method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <input type="text" name="info" placeholder="Enter book info" class="form-control  form-control-line">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12 mb-0">Book author</label>
                            <div class="col-md-12">
                                <input type="text" name="author" placeholder="Enter book author" class="form-control  form-control-line">
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-md-12 mb-0">Book release date</label>
                            <div class="col-md-12">
                                <input type="date" name="release_date" placeholder="Enter release date" class="form-control  form-control-line">
                            </div>
                        </div>
